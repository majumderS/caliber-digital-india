var DiffCamEngine = (function() {
    ...
    function callMicrosoftapi(data,score) {
        ...
        //microsoft api javascript

    function makeblob(dataURL) {
    //window.alert("inside blobmaker");
...
// **********************************************
        ...
        var subscriptionKey = "04d690dedab04bd4ae3c22e394ece2f2";
        ...
        .done(function(data) {
            ...
            //window.alert(JSON.stringify(data['description']['captions'][0]['text'], null, 2))
            var msg = new SpeechSynthesisUtterance("I can see "+JSON.stringify(data['description']['captions'][0]['text']));
	...
	function capture() {
        ...
        //ayush
        var data = captureCanvas.toDataURL('image/png');
		...
		diffContext.drawImage(video, 0, 0, diffWidth, diffHeight);
		isReadyToDiff = true;
		callMicrosoftapi(data,diff.score)
	}
